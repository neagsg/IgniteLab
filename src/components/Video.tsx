...
const GET_LESSON_SLUG_QUERY = gql`
  query GetLessonSlugQuery($slug: String) {
...
interface GetLessonSlugQueryResponse {
  lesson: {
    title: string;
    videoId: string;
    description: string;
...
export function Video({ lessonSlug }: VideoProps) {
  const { data } = useQuery<GetLessonSlugQueryResponse>(GET_LESSON_SLUG_QUERY, {
    variables: {
      slug: lessonSlug,
    }
  })
    ...
    <div className="flex-1">
      ...
      <div className="p-8 max-w-[1100px] mx-auto">
        ...
        <div className="gap-8 mt-20 grid grid-cols-2">
          <a href="" className="rounded bg-gray-700 overflow-hidden flex items-stretch gap-6 hover:bg-gray-600 transition-colors">
